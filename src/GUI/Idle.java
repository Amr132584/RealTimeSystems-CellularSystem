...
public class Idle extends JFrame {
    ...
    public Idle() {
        ...
        JButton clearButton = new JButton("End");
...
//        _logic.setTotal("0");
    ...
    class OpListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (false) { // Error: needed number, not operator
...
//                        _logic.setTotal(displayText);
                    } else if (_previousOp.equals("Off")) {

                        MainClass.engine.getEPRuntime().sendEvent(new OffPressed());

                    } else if (_previousOp.equals("send")) {
                        System.out.println(_displayField.getText());
                        MainClass.engine.getEPRuntime().sendEvent(new CallRequest(_displayField.getText()));
